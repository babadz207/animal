...
// Extract {"id":"...","assetId":"..."} JSON string elements from steps 1146, 1148, 1150, 1152
...
while ((match = itemRegex.exec(allText)) !== null) {
    ...
    // Exclude any single quote trailing item (Apple', Banana', Candycane') or non-pets
...
console.log('==================================================');
console.log(`📦 BẮT ĐẦU TẢI CHUẨN 100% BỘ ${itemsArray.length} / 3,494 PETS TRONG GAME!`);
console.log('==================================================\n');
