...
// Extract {"id":"...","assetId":"..."} JSON string elements from step 1106
...
while ((match = itemRegex.exec(allText)) !== null) {
    ...
    // STRICT PET FILTER: Exclude any item name that ends with a single quote (e.g. Apple', Banana', Candycane') or non-pet keywords
...
console.log('==================================================');
console.log(`📦 BẮT ĐẦU TẢI CHUẨN 100% PURE PETS (${itemsArray.length} PETS KHÔNG DỌN TRÚNG MỘT FILE RÁC NÀO)!`);
console.log('==================================================\n');
