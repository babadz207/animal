...
async function downloadPetArray(itemsArray) {
    console.log(`🚀 [TẢI ĐA LUỒNG SIÊU TỐC 30 WORKERS] Bắt đầu tải ${itemsArray.length} Pet Icons...\n`);
...
module.exports = { downloadPetArray };
