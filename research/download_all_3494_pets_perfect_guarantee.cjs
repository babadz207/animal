...
// Regex to capture escaped json elements: \"id\":\"...\",\"assetId\":\"...\" from steps 1157-1160
...
console.log('==================================================');
console.log(`📦 BẮT ĐẦU NẠP ĐỦ 100% BỘ ${itemsArray.length} PURE PETS TỪ DIRECTORY.PETS CỦA GAME!`);
console.log('==================================================\n');
...
if (fs.existsSync(outputDir)) {
    ...
    console.log(`🧹 Đã làm sạch 100% thư mục Pets để xóa toàn bộ các file vật phẩm rác cũ!\n`);
} else {
