...
console.log('==================================================');
console.log(`📦 BẮT ĐẦU KÉO BỔ SUNG ĐỦ ${itemsArray.length} PURE PETS CHUẨN IN GAME!`);
console.log('==================================================\n');
...
async function startFastBatchDownload() {
    console.log(`🚀 [SIÊU TỐC ĐA LUỒNG 30 WORKERS] Bắt đầu tải bổ sung PURE PETS còn thiếu...\n`);
        ...
        try {
            ...
            if (status === 'downloaded') {
                ...
                if (downloadedCount % 50 === 0 || downloadedCount === downloadQueue.length) {
                    console.log(`  ⚡ [${downloadedCount}/${downloadQueue.length}] ✅ Tải bổ sung Pet: ${task.filename}`);
                }
            } else {
                skippedCount++;
            }
    ...
    console.log('\n==================================================');
    console.log('🎉 TỔNG KẾT QUÁ TRÌNH TẢI BỔ SUNG 100% PURE PETS:');
    console.log(`⏱️ Thời gian hoàn tất: ${elapsedSeconds} Giây!`);
    console.log(`• Tải mới bổ sung: ${downloadedCount} file PNG (100% Pure Pets)`);
