...
async function startBatchDownload(itemsArray) {
    console.log(`🚀 [TẢI SIÊU TỐC 30 LUỒNG] Bắt đầu tải TOÀN BỘ ${itemsArray.length} Pet Icons...\n`);
...
module.exports = { startBatchDownload };
